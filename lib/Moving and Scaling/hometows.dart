...
class hometows extends StatefulWidget {
  const hometows({super.key});

  @override
  State<hometows> createState() => _hometowsState();
}

class _hometowsState extends State<hometows> {
  ...
  Transform _TFScaleAndTranslate() {
    return Transform.scale(
      ...
      child: Transform.translate(
        ...
        child: Image(
          image: AssetImage('images/jojo.jpg'),
        ),
      ),
    );
  }
